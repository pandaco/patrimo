...
export const MOCK_GLOSSARY: GlossaryEntry[] = [
  ...
  { term:'Capital investi', title:'Rendement sur capital investi', body:'Ton gain en euros rapporté à l\'argent réellement engagé : valeur de départ + versements et achats de la période. C\'est le « j\'ai mis X, j\'ai gagné Y, soit Z % ». Contrairement au TWR, il tient compte du montant investi (ce que TON argent a rapporté) ; contrairement au rendement annuel d\'un actif, il ne se compare pas directement à un ETF. Il reste stable quelle que soit la durée regardée.', example:'Tu as investi 1 145 € en tout et ta poche vaut 1 557 € → +412 €, soit +36 % sur le capital investi.' },
  ...
  { term:'Allocation',  title:'Stratégique vs tactique',       body:'Deux niveaux de décision. L\'allocation <b>stratégique</b> fixe le grand partage long terme entre actions (croissance) et obligations (stabilité) selon ton profil et ton horizon — on n\'y touche presque jamais. L\'allocation <b>tactique</b> découpe ensuite la poche actions en sous-poches (Core / Satellite) et s\'ajuste un peu plus souvent. Les deux doivent sommer à 100 %.', example:'Stratégique 80/20 → tactique : Core 64 % / Satellite 16 % / Obligations 20 %.' },
  { term:'Core / Satellite', title:'Cœur et satellites',       body:'Méthode pour structurer la poche actions. Le <b>Core</b> (cœur, 70–90 %) est large et diversifié — un ETF monde ou S&P 500 — et porte la performance sans paris. Les <b>Satellites</b> (≤ 30 %) sont des paris ciblés et plus volatils autour du cœur : small caps, marchés émergents, un secteur. C\'est le piment, pas le plat principal.', example:'Core MSCI World 75 % + Satellites émergents 15 % + small caps EU 10 %.' },
];
