...
export const MOCK_ETFS: Etf[] = [
  { isin:'FR0010315770', ticker:'ESE',   name:'Amundi S&P 500 UCITS',         issuer:'Amundi',  index:'S&P 500',           ter:0.15, currency:'EUR', repli:'Synthétique', distrib:'Capitalisant', pea:true,  alloc:'Core',        qty:47,  pru: 32.18, price: 39.42, prev: 39.18, perf1y:22.4, perfYtd:14.2 },
  { isin:'FR0010261198', ticker:'CW8',   name:'Amundi MSCI World UCITS',      issuer:'Amundi',  index:'MSCI World',        ter:0.38, currency:'EUR', repli:'Synthétique', distrib:'Capitalisant', pea:true,  alloc:'Core',        qty:22,  pru:412.50, price:498.20, prev:494.10, perf1y:18.1, perfYtd:11.8 },
  { isin:'LU1681043599', ticker:'PCEU',  name:'Amundi MSCI Europe UCITS',     issuer:'Amundi',  index:'MSCI Europe',       ter:0.18, currency:'EUR', repli:'Physique',    distrib:'Capitalisant', pea:true,  alloc:'Core',        qty:38,  pru: 22.10, price: 25.84, prev: 25.92, perf1y:11.2, perfYtd: 6.4 },
  { isin:'LU1681045370', ticker:'PAEEM', name:'Amundi MSCI Emerging Markets', issuer:'Amundi',  index:'MSCI EM',           ter:0.20, currency:'EUR', repli:'Synthétique', distrib:'Capitalisant', pea:true,  alloc:'Satellite',   qty:64,  pru:  5.42, price:  5.78, prev:  5.74, perf1y: 6.8, perfYtd: 3.1 },
  { isin:'IE00BJZ2DD79', ticker:'RS2K',  name:'SPDR Russell 2000 US Small',   issuer:'SPDR',    index:'Russell 2000',      ter:0.30, currency:'USD', repli:'Physique',    distrib:'Capitalisant', pea:false, alloc:'Satellite',   qty:14,  pru: 58.40, price: 62.10, prev: 61.80, perf1y: 9.2, perfYtd: 4.4 },
  { isin:'FR0011550185', ticker:'EWLD',  name:'Lyxor MSCI World UCITS',       issuer:'Lyxor',   index:'MSCI World',        ter:0.45, currency:'EUR', repli:'Synthétique', distrib:'Capitalisant', pea:true,  alloc:'Core',        qty:18,  pru:412.20, price:498.00, prev:494.20, perf1y:18.0, perfYtd:11.7 },
  { isin:'IE00B4L5Y983', ticker:'IWDA',  name:'iShares Core MSCI World',      issuer:'iShares', index:'MSCI World',        ter:0.20, currency:'USD', repli:'Physique',    distrib:'Capitalisant', pea:false, alloc:'Core',        qty: 8,  pru: 78.40, price: 89.20, prev: 89.05, perf1y:18.3, perfYtd:11.9 },
  { isin:'FR0013412020', ticker:'OBLI',  name:'Amundi Euro Govt Bond 7-10Y',  issuer:'Amundi',  index:'Bloomberg Euro Govt',ter:0.14, currency:'EUR', repli:'Physique',    distrib:'Capitalisant', pea:false, alloc:'Obligations', qty:32,  pru:135.10, price:138.40, prev:138.20, perf1y: 3.4, perfYtd: 1.8 },
];
