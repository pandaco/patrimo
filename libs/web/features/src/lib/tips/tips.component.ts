...
const TIPS: Tip[] = [
  ...
  },
  {
    ...
    takeaway: 'MSCI World ne contient PAS la Chine, l\'Inde, le Brésil ou l\'Asie du Sud-Est. Pour aller vers MSCI ACWI (All Country World Index), ajoute 10-15 % d\'EM.',
