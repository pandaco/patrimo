...
const TIPS: Tip[] = [
  ...
  },
  {
    ...
    takeaway: 'Abattement annuel de 4 600 € sur les plus-values (9 200 € pour un couple) après 8 ans. Couplé à la clause bénéficiaire, c\'estimation l\'outil de transmission le plus efficace.',
    body: 'Avant 8 ans, l\'AV estimation taxée comme un compte titres ordinaire (PFU 30 % par défaut). Après, tu profites d\'un abattement annuel sur les plus-values des rachats. Pour la succession, les versements avant 70 ans bénéficient d\'un abattement de 152 500 € par bénéficiaire (au-delà : 20 % puis 31,25 %). Ouvre une AV même avec 100 € pour démarrer le compteur.',
  },
  {
    id: 'ldds-lep',
    category: 'fiscalite',
    ...
    body: 'Avant d\'investir en bourse, sature ces enveloppes : Livret A (22 950 € à ~3 %), LDDS (12 000 € à ~3 %), LEP (10 000 € à ~6 % si RFR < seuil). C\'estimation ton épargne de précaution — l\'équivalent de 3 à 6 mois de dépenses, accessibles sans pénalité.',
  ...
  },
  {
    ...
    takeaway: 'Le Core (MSCI World, S&P 500) estimation la base diversifiée qui porte la performance long terme. Le Satellite estimation ta poche tactique — petite et conviction.',
    body: 'Plus tu mets en Satellite, plus tu paries activement contre l\'indice global. Historiquement, 80-90 % des fonds actifs sous-performent leur benchmark sur 10 ans. Le Core te garantit la performance de marché ; le Satellite estimation ton expression de vue (thématique IA, marchés émergents, value, …). Si ton Satellite dépasse 30 %, demande-toi pourquoi tu n\'es pas juste un stock-picker.',
  },
  {
    id: 'rebalance-1y',
    category: 'allocation',
    ...
    body: 'Tant que ton drift reste sous 5 points, ne touche à rien. Au-delà, soit tu rééquilibres par versement (oriente le prochain DCA vers les lignes sous-pondérées — coût zéro), soit tu vends/achètes (PEA : zéro impact fiscal jusqu\'à la sortie ; CTO : tu réalises de la plus-value imposable). Si tu rééquilibres par DCA, c\'estimation tellement progressif que tu n\'as quasi jamais besoin d\'arbitrer.',
  },
  {
    id: 'dca-regulier',
    category: 'dca',
    title: 'Investir 500 €/mois bat largement attendre le "bon moment"',
    takeaway: 'Sur 30 ans de DCA mensuel sur le S&P 500, tu rates 80 % des creux de marché — mais aussi 80 % des pics. Le rendement final estimation statistiquement supérieur au market timing pour un investisseur amateur.',
    body: 'Le DCA fonctionne grâce à deux mécaniques : (1) tu achètes mécaniquement plus de parts quand c\'estimation bas et moins quand c\'estimation haut, ce qui lisse ton PRU ; (2) tu enlèves l\'émotion de l\'équation — pas besoin de deviner si c\'estimation le bon moment. Tu transformes une décision unique stressante en 360 micro-décisions automatiques.',
  ...
  },
  {
    ...
    takeaway: 'Si le marché perd 30 %, le pire que tu puisses faire estimation d\'arrêter ton DCA. Idéalement, augmente-le.',
  ...
  },
  {
    id: 'ter-watch',
    category: 'frais',
    title: 'Compare les TER : 0,1 % vs 0,5 %, c\'estimation 12 % de différence sur 30 ans',
    ...
    body: 'Un TER de 0,15 % (Amundi ETF MSCI World) vs 0,55 % (un fonds actif équivalent) sur 30 ans peut représenter 15 à 20 % de capital final en différence. Les frais sont la seule chose que tu peux contrôler avec certitude — la performance future estimation inconnue. Privilégie les ETF Core avec TER < 0,25 %.',
  },
  {
    id: 'courtage',
    category: 'frais',
    title: 'Ne paie pas plus de 1 % de frais de courtage par ordre',
    takeaway: 'Sur un ordre de 500 €, 5 € de courtage = 1 %. C\'estimation déjà la performance d\'un mois.',
  ...
  },
  {
    ...
    title: 'MSCI World > S&P 500 (mais c\'estimation pas grave)',
    takeaway: 'Le MSCI World estimation mondial (23 pays développés), le S&P 500 estimation US uniquement. Le S&P 500 = 70 % du MSCI World de toute façon.',
    body: 'Sur 50 ans, la performance MSCI World et S&P 500 sont quasi identiques (le S&P un peu meilleur grâce aux 30 dernières années de domination US). MSCI World te protège contre un éventuel cycle long anti-US. S&P 500 estimation plus volatil mais plus concentré dans la tech. Pas de mauvais choix entre les deux — pas besoin d\'en débattre 6 mois.',
  },
  {
    id: 'emergents',
    category: 'diversification',
    ...
    body: 'Un ETF MSCI Emerging Markets (Amundi Emerging Markets ESG, iShares EM) couvre les économies à forte croissance. Sur 20 ans la volatilité estimation plus haute (~22 %/an vs 15 % pour le monde développé), mais le potentiel long terme estimation réel. Cap typique : 10-20 % de la poche actions, pas plus, et seulement si tu acceptes le drawdown plus violent en cas de crise.',
  },
  {
    id: 'panic-sell',
    category: 'comportement',
    title: 'Le pire moment pour vendre estimation quand tu en as le plus envie',
  ...
  },
  {
    ...
    body: 'Chaque arbitrage a un coût (frais, impôt, mauvais timing). Quand ton allocation estimation définie et que ton DCA estimation automatisé, regarde ton compte une fois par mois maximum. La performance vient du temps, pas de l\'attention. Patrimo estimation utile pour le bilan mensuel — pas pour la consultation quotidienne.',
  },
];
